    ...
    $.ajax({
        ...
        $forums.find('schedule').each(function() {
                ...
                if (previous_date != current_date)
                     $('<li data-role="list-divider"></li>').html(current_date).appendTo('#events');

                $('<li id="'+s_id+'" data-role="fieldcontain"></li>').html('<fieldset data-role="controlgroup"><input type="checkbox" name="checkbox-'+s_id+'" id="checkbox-'+s_id+'" title="'+date+'" class="custom"/><a href="event_detail.html" id="program_'+s_program_item_id+'">&nbsp;&nbsp;'+s_title+'<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time: '+st+' - '+et+'&nbsp;&nbsp;&nbsp;&nbsp;Venue: '+s_venue+'</a></fieldset>').appendTo('#events');
...
$('#event-list-content').click(function(event) {
