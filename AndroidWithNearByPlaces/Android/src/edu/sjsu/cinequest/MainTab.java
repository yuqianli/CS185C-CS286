...
import edu.sjsu.cinequest.googleplacesandmaps.*;
...
public class MainTab extends TabActivity {
	...
	public static final int NEAR_PLACES_TAB = 5;
    ...
    public void onCreate(Bundle savedInstanceState) {    	    	
        ...
        intent = new Intent().setClass(this,MainActivity.class); // Change this
        spec = tabHost.newTabSpec("nearPlaces").setIndicator("Near Places",getResources().getDrawable(R.drawable.near_place_icon)).setContent(intent);
        tabHost.addTab(spec);
