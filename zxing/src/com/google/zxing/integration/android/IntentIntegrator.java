...
public class IntentIntegrator {
  ...
  /**
   * Initiates a scan by class name
   */
  public AlertDialog initiateScan(Context aContext, Class<?> aClass) {
    return initiateScan(ALL_CODE_TYPES,aContext, aClass);
  }
  ...
  public AlertDialog initiateScan(Collection<String> desiredBarcodeFormats, Context aContext, Class<?> aClass) {
    Intent intentScan = new Intent(aContext, aClass);
